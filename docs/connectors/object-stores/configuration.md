...
### Azure Blob Storage Server Configuration {#abs_cfg}
...
### Azure Data Lake Storage Gen2 Server Configuration {#abfss_cfg}
...
### Google Cloud Storage Server Configuration {#gcs_cfg}
