...
## Creating the External Table {#hdfswrite_writeextdata}
...
## Reading and Writing Binary Data {#write_binary}
...
### Example: Writing Binary Data to HDFS {#write_seqfile_example}
...
3. Restart PXF on each Greenplum Database host as described in [Restarting PXF](../../administration/start-stop-restart.md#restart_pxf).
...
## Reading the Record Key {#read_recordkey}
...
### Example: Using Record Keys {#read_recordkey_example}
