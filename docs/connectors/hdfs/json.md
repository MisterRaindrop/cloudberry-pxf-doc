...
## Working with JSON Data {#hdfsjson_work}
...
### About the PXF JSON Data Access Modes {#topic_jsonmodes}
...
#### Single Object Per File {#arrayobject}
...
### Write Mapping {#datatypemap_write}
...
## About Using Projection (Read) {#projection}
...
## Read Examples {#json_read}

### Example Data Sets {#example_datasets}
...
### Loading the Sample JSON Data to HDFS {#jsontohdfs}
...
### Example: Single Object Per Row (Read) {#read_example1}
...
### Example: Single Object Per File (Read) {#read_example2}
...
### Other Methods to Read a JSON Array {#array_other}
...
#### Using Array Element Projection {#arrayelproj}
...
#### Specifying a Single Text-type Column {#singletextcol}
...
### Example: Single Object Per Row (Write) {#write_example1}
...
### Example: Single Object Per File (Write) {#write_example2}
