...
Ensure that you have met the PXF Hadoop [Prerequisites](./overview.md#hadoop_prereq) before you attempt to read fixed-width text from, or write fixed-width text to, HDFS.

## Reading Text Data with Fixed Widths {#profile_fixedwidth}
...
## About Specifying field_name and width {#about_fields}
...
## About the line_delim and NEWLINE Formatter Options {#about_lineend}
...
## Example: Reading Fixed-Width Text Data on HDFS {#fixedwidth_read_example}
...
## Writing Fixed-Width Text Data to HDFS {#hdfswrite_text}
...
## Example: Writing Fixed-Width Text Data to HDFS {#fixedwidth_write_example}
...
#### Procedure {#fixedwidth_write_proc}
