...
Ensure that you have met the PXF Hadoop [Prerequisites](./overview.md#hadoop_prereq) before you attempt to read data from or write data to HDFS.

## Reading Text Data {#profile_text}
...
| Keyword  | Value |
|-------|-------------------------------------|
| \<path&#8209;to&#8209;hdfs&#8209;file\>    | The path to the directory or file in the HDFS data store. When the `<server_name>` configuration includes a [`pxf.fs.basePath`](../../administration/server-configuration.md#pxf-fs-basepath) property setting, PXF considers \<path&#8209;to&#8209;hdfs&#8209;file\> to be relative to the base path specified. Otherwise, PXF considers it to be an absolute path. \<path&#8209;to&#8209;hdfs&#8209;file\> must not specify a relative path nor include the dollar sign (`$`) character. |
...
### Example: Reading Text Data on HDFS {#profile_text_query}
...
## Reading Text Data with Quoted Linefeeds {#profile_textmulti}
...
### Example: Reading Multi-Line Text Data on HDFS {#profile_textmulti_query}
...
## Writing Text Data to HDFS {#hdfswrite_text}
...
| Keyword  | Value |
|-------|-------------------------------------|
| \<path&#8209;to&#8209;hdfs&#8209;dir\>    | The path to the directory in the HDFS data store. When the `<server_name>` configuration includes a [`pxf.fs.basePath`](../../administration/server-configuration.md#pxf-fs-basepath) property setting, PXF considers \<path&#8209;to&#8209;hdfs&#8209;dir\> to be relative to the base path specified. Otherwise, PXF considers it to be an absolute path. \<path&#8209;to&#8209;hdfs&#8209;dir\> must not specify a relative path nor include the dollar sign (`$`) character. |
...
### Example: Writing Text Data to HDFS {#write_hdfstextsimple_example}
...
#### Procedure {#write_hdfstextsimple_proc}
...
## About Setting the External Table Encoding {#about_encoding}
...
## About Reading Data Containing Multi-Byte or Multi-Character Delimiters {#multibyte_delim}
...
### Specifying the Delimiter {#about_delim}
...
#### About Specifying the Byte Representation of the Delimiter {#delim_byterep}
...
### About Specifying Quote and Escape Characters {#about_qe}
...
### About the NEWLINE Options {#about_newline}
...
### Examples {#mbd_examples}

#### Delimiter with Quoted Data {#qe_example}
...
#### Delimiter with Quoted and Escaped Data {#qe_example}
