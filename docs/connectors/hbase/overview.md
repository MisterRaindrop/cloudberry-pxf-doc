...
- Met the PXF Hadoop [Prerequisites](../hdfs/overview.md#hadoop_prereq).

## HBase Primer {#hbase_primer}
...
### Example: Creating an HBase Table {#hbaseshell_example}
...
## Querying External HBase Data {#syntax3}
...
## Data Type Mapping {#datatypemapping}
...
### Indirect Mapping via Lookup Table {#indirectmappingvialookuptable}
