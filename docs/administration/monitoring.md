...
## Viewing PXF Status on the Command Line {#status}
...
## About PXF Service Runtime Monitoring {#about_rtm}
...
If you chose the [alternate deployment topology](./deployment-topologies.md#alt_topo) for PXF, the URL is:
...
### Examining PXF Metrics {#examine_metrics}
...
### Filtering Metric Data {#filter_metrics}
