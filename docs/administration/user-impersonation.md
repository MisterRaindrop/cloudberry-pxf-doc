...
You configure the Hadoop user and PXF user impersonation setting for a server via the `pxf-site.xml` server configuration file. Refer to [About the pxf-site.xml Configuration File](./server-configuration.md#pxf-site) for more information about the configuration properties in this file.

## Use Cases and Configuration Scenarios {#pxf_cfg_scenarios}
...
If you are using PXF to access a *Kerberos-secured Hadoop cluster*, refer to the [Use Cases and Configuration Scenarios](./kerberos.md#scenarios) section in the *Configuring PXF for Secure HDFS* topic.

**Note**: These scenarios assume that `gpadmin` is the PXF process owner.

### Accessing Hadoop as the Greenplum User Proxied by gpadmin {#default_case}
...
![Accessing Hadoop as the Greenplum User Proxied by gpadmin](/img/graphics/impersonation_cases/impersonation-case-1.png "Accessing Hadoop as the Greenplum User Proxied by gpadmin")
...
### Accessing Hadoop as the Greenplum User Proxied by a &lt;custom> User {#custom_proxy}
...
![Accessing Hadoop as the Greenplum User Proxied by a custom User](/img/graphics/impersonation_cases/impersonation-case-2.png "Accessing Hadoop as the Greenplum User Proxied by a custom User")
...
### Accessing Hadoop as the gpadmin User {#gpadmin_hadoop}
...
![Accessing Hadoop as the gpadmin User](/img/graphics/impersonation_cases/impersonation-case-3.png "Accessing Hadoop as the gpadmin User")
...
![Accessing Hadoop as a custom User](/img/graphics/impersonation_cases/impersonation-case-4.png "Accessing Hadoop as a custom User")
...
## Configure the Hadoop User {#pxf_cfg_user}
...
## Configure PXF User Impersonation {#pxf_cfg_impers}
...
## Configure Hadoop Proxying {#hadoop}
...
## HBase User Impersonation {#hbase}
