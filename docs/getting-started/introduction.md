...
## About Connectors, Servers, and Profiles {#more}
...
## Creating an External Table {#create_external_table}
...
| PROFILE=\<profile_name\>  | The profile that PXF uses to access the data. PXF supports profiles that access text, Avro, JSON, RCFile, Parquet, SequenceFile, and ORC data in [Hadoop services](../connectors/hdfs/overview.md), [object stores](../connectors/object-stores/overview.md), [network file systems](../connectors/nfs.md), and [other SQL databases](../connectors/jdbc/overview.md).  |
...
- [About PXF Filter Pushdown](../advanced/filter-pushdown.md)
- [About Column Projection in PXF](../advanced/column-projection.md)
