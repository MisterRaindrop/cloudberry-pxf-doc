...
## Pre-gpupgrade Actions {#pre}

Before you run `gpupgrade`, perform the following steps:

1. Upgrade your Greenplum Database 5.x PXF installation to the latest release (6.3.0 or newer); refer to the [Upgrading PXF](./overview.md) documentation for instructions on upgrading PXF.
...
## Customizing the Greenplum Connection Parameters {#env}
