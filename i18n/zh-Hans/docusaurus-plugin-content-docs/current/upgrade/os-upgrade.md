...
1. Copy the PXF configuration files from the original cluster to `/user/local/pxf-gp6` on the upgraded OS Greenplum Database coordinator host. If you choose to [relocate $PXF_BASE](../administration/directory-structure.md#movebase), copy the configuration to that directory instead.
