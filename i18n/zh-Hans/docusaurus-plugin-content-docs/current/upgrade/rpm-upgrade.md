...
2. Stop PXF on each segment host as described in [Stopping PXF](../administration/start-stop-restart.md#stop_pxf).
...
5. Start PXF on each segment host as described in [Starting PXF](../administration/start-stop-restart.md#start_pxf).
