...
## Required Configuration Updates {#affected-configs}

### Profile Configurations (`pxf-profiles-default.xml`) {#profiles}
...
### Logging Configuration (`pxf-log4j2.xml`) {#logging}
...
### Existing External Tables {#external-tables}
