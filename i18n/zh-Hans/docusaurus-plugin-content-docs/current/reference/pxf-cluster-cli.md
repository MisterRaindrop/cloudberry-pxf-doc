...
If you want to manage the PXF Service instance on a specific segment host, use the `pxf` utility. See [`pxf`](./pxf-cli.md#topic1).
...
## See Also {#topic1__section6}

[`pxf`](./pxf-cli.md#topic1)
