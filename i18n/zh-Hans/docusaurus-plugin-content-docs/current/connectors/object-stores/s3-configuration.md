...
## About Object Store Configuration {#about_cfg}

To access data in an object store, you must provide a server location and client credentials. When you configure a PXF object store connector, you add at least one named PXF server configuration for the connector as described in [Configuring PXF Servers](../../administration/server-configuration.md).
...
## MinIO Server Configuration {#minio_cfg}
...
## S3 Server Configuration {#s3_cfg}
...
#### Configuring SSE via an S3 Bucket Policy (Recommended) {#s3-sse-bucket}
...
#### Specifying SSE Options in a PXF S3 Server Configuration {#s3-sse-pxfs3cfg}
...
## Example Server Configuration Procedure {#cfg_proc}
...
## Dell ECS Server Configuration {#ecs_cfg}
